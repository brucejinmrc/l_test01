...
public class ReadMailOther {
     ...
     **********************************************************************/
	public ReadMailOther(String protocol, String emailServer, String emailAccount,
			String emailPswd) {
		super();
	...
	public static void main(String[] args) {
		...
		String emailServer = "pop.mail.yahoo.com";
		String emailAccount = "b2b007@yahoo.com";
		String emailPswd = "rrr";
		ReadMailOther read = new ReadMailOther(protocol, emailServer, emailAccount, emailPswd);
